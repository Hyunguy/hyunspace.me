      ...
      <div className="about-main">
        <section className="about-chapter about-intro">
          ...
          <div className="about-intro-copy about-outline-text">
            <p data-fuser-slot-id="section-body-3b909d61" className="about-lede"><strong data-fuser-slot-id="section-text-b3acaa80" className="readable-name">HYUN</strong> is a Stevens Institute of Technology ('28) student, <span data-fuser-slot-id="section-text-7cecd460" className="sweep-highlight">game programmer, graphics engineer, and toolmaker</span> building high-performance real-time interactive systems.</p>
